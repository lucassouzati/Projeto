...
@section('content')
      ...
      <div class="right_col" role="main">
          ...
          <div class="rating" alt="favoritar categoria"><span alt="favoritar categoria"><i class="fa fa-heart-o" aria-hidden="true" alt="favoritar categoria"></i>
        </div>
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <div class="col-md-5 col-sm-5 col-xs-12" style="border:0px solid #e5e5e5;">
                    ...
                    <div class="">
                      <button type="button" class="btn btn-success">Confirmar Presença</button>
